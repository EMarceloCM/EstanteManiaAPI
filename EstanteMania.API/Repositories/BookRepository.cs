...
#nullable disable
    public class BookRepository : Repository<Book>, IBookRepository
    {
        ...
        public async Task<BookWithAuthor> FindBookWithAuthorByIdAsync(int bookId)
        {
            var bookWithAuthor = await _context.Book.Where(x => x.Id == bookId).Select(x => new BookWithAuthor
            {
                Book = x,
                Author = x.Author
